 ...
 * All functions are now modularized into 5 directories:
 ...
 * - lib/team: Agent Teams coordinator, strategy, hooks
 *
...
module.exports = {
  ...
  readBkitMemory: pdca.readBkitMemory,
  writeBkitMemory: pdca.writeBkitMemory,
  ...
  generateBatchTrigger: pdca.generateBatchTrigger,
  shouldSuggestBatch: pdca.shouldSuggestBatch,
  ...
  // Hooks (2 exports)
  assignNextTeammateWork: team.assignNextTeammateWork,
  handleTeammateIdle: team.handleTeammateIdle,

  // Orchestrator (6 exports)
  PHASE_PATTERN_MAP: team.PHASE_PATTERN_MAP,
  selectOrchestrationPattern: team.selectOrchestrationPattern,
  composeTeamForPhase: team.composeTeamForPhase,
  generateSpawnTeamCommand: team.generateSpawnTeamCommand,
  createPhaseContext: team.createPhaseContext,
  shouldRecomposeTeam: team.shouldRecomposeTeam,

  // Communication (6 exports)
  MESSAGE_TYPES: team.MESSAGE_TYPES,
  createMessage: team.createMessage,
  createBroadcast: team.createBroadcast,
  createPhaseTransitionNotice: team.createPhaseTransitionNotice,
  createPlanDecision: team.createPlanDecision,
  createDirective: team.createDirective,

  // Task Queue (5 exports)
  createTeamTasks: team.createTeamTasks,
  assignTaskToRole: team.assignTaskToRole,
  getTeamProgress: team.getTeamProgress,
  findNextAvailableTask: team.findNextAvailableTask,
  isPhaseComplete: team.isPhaseComplete,

  // CTO Logic (5 exports)
  decidePdcaPhase: team.decidePdcaPhase,
  evaluateDocument: team.evaluateDocument,
  evaluateCheckResults: team.evaluateCheckResults,
  selectAgentsForRole: team.selectAgentsForRole,
  recommendTeamComposition: team.recommendTeamComposition,

  // State Writer (9 exports) - v1.5.3: Team Visibility
  initAgentState: team.initAgentState,
  updateTeammateStatus: team.updateTeammateStatus,
  addTeammate: team.addTeammate,
  removeTeammate: team.removeTeammate,
  updateProgress: team.updateProgress,
  addRecentMessage: team.addRecentMessage,
  cleanupAgentState: team.cleanupAgentState,
